...
- [**FTPiiU Plugin**](./requirements.md#software): This plugin facilitates the transfer of general files between your PC[^1] and the Wii U using the FTP protocol. This tool also provides the capability to inspect the Wii U's local file system, which can be valuable for debugging purposes.
